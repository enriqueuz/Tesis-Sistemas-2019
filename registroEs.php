...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="alert alert-success">Se ha registrado el estudiante exitosamente.</div>
        <?php elseif( isset($_GET['err_nombre']) && $_GET['err_nombre'] == 1): ?>
        <div class="alert alert-warning">Ingrese el nombre del estudiante.</div>
		<?php elseif( isset($_GET['err_apellido']) && $_GET['err_apellido'] == 1): ?>
        <div class="alert alert-warning">Ingrese el apellido del estudiante.</div>
		<?php elseif( isset($_GET['err_cedula']) && $_GET['err_cedula'] == 1): ?>
        <div class="alert alert-warning">Ingrese la cédula del estudiante.</div>
		<?php elseif( isset($_GET['err_telefono']) && $_GET['err_telefono'] == 1): ?>
        <div class="alert alert-warning">Ingrese el teléfono del estudiante.</div>
		<?php elseif( isset($_GET['err_sexo']) && $_GET['err_sexo'] == 1): ?>
        <div class="alert alert-warning">Seleccione el sexo del estudiante.</div>
       	<?php elseif( isset($_GET['cedulaRep']) && $_GET['cedulaRep'] == 1): ?>
        <div class="alert alert-warning">El número de cédula ya existe</div>
        <?php endif; ?>
        <br>
