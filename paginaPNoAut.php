...
<body>
    ...
    <div class="bg">
        ...
        <br>
        	<div class="container py-2 alert alert-danger col-lg-5" align="center"><h5>Usted no está autorizado para está acción, por favor elija otra</h5></div>	
        <br>
        ...
        <div class="form-check">
            <nav align="center">
                ...
                <button class="btn btn-secondary" onclick="window.location.href='chequeoPa.php'">Chequear pagos</button>
